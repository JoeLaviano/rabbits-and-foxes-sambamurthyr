##This is my original Python Code for the Rabbits and Foxes assignment. As there was originally no code to improve,
##I input my own as example, as well as commented it out and mad further improvements as if it were someone else's.

##The Euler's Method and ODEint are fairly straight forward, so I only included KMC in this improvement cycle
import numpy as np
